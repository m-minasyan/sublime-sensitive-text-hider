...
class HideSensitiveTextCommand(sublime_plugin.TextCommand):
    def run(self, edit):
...
class RevealSensitiveTextCommand(sublime_plugin.TextCommand):
    def run(self, edit):
        view_id = self.view.id()
        file_name = self.view.file_name()
...
class ToggleSensitiveTextCommand(sublime_plugin.TextCommand):
    def run(self, edit):
        view_id = self.view.id()
        file_name = self.view.file_name()
        ...
        if has_backup:
            self.view.run_command('reveal_sensitive_text')
        else:
            self.view.run_command('hide_sensitive_text')
